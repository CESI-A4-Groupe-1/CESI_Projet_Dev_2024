...
--
-- Temporary view structure for view `V_GestionComm`
--
...
INSERT INTO `articles` VALUES (1,'Bruschetta',5.5,1,'Pain grill avec tomates, ail et huile d\'olive.'),(2,'Spaghetti Carbonara',12,2,'Ptes avec sauce carbonara.'),(3,'Sushi de Saumon',8.5,3,'Sushis au saumon frais.'),(4,'Ramen',10,4,'Soupe de nouilles japonaise.'),(5,'Taco au Poulet',4.5,5,'Taco avec poulet pic.'),(6,'Burrito de Buf',7.5,6,'Burrito avec buf, riz et haricots.'),(7,'Cheeseburger',9,7,'Burger avec fromage et lgumes.'),(8,'Frites Maison',3,8,'Frites faites maison.'),(9,'Curry de Poulet',11,9,'Curry avec poulet et riz.'),(10,'Samosa',2,10,'Snacks indiens pics.'),(11,'Penne alla Vodka',13.5,11,'Ptes avec sauce vodka.'),(12,'Udon Noodles',9.5,12,'Nouilles paisses japonaises.'),(13,'Burrito de Haricots',6,13,'Burrito avec haricots noirs.');
...
INSERT INTO `categories` VALUES (1,'Teal'),(2,'Crimson'),(3,'Maroon'),(4,'Crimson'),(5,'Khaki'),(6,'Violet'),(7,'Orange'),(8,'Turquoise'),(9,'Khaki'),(10,'Mauv'),(11,'Pink'),(12,'Crimson'),(13,'Aquamarine'),(14,'Yellow'),(15,'Blue'),(16,'Yellow'),(17,'Pink'),(18,'Khaki'),(19,'Maroon'),(20,'Turquoise'),(21,'Italiens'),(22,'Amricain'),(23,'Indien');
...
INSERT INTO `commande_list` VALUES (1,1,1,2),(2,3,2,4),(3,5,3,3);
...
INSERT INTO `commandes` VALUES (1,1,1,1,'2024-06-14 13:56:09','2024-06-14 13:56:09','2024-06-14 13:56:09',NULL),(2,2,2,2,'2024-06-14 13:56:09','2024-06-14 13:56:09','2024-06-14 13:56:09',NULL),(3,3,3,3,'2024-06-14 13:56:09','2024-06-14 13:56:09','2024-06-14 13:56:09',NULL);
...
INSERT INTO `livraisons` VALUES (1,4,'40 Avenue du Bon Got, New York','123 Rue Italienne, Rome','Scooter','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59'),(2,5,'50 Avenue du Got, Delhi','456 Rue Japonaise, Tokyo','Vlo','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59'),(3,3,'30 Rue de la Fiesta, Mexico','789 Rue Mexicaine, Mexico','Voiture','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59','2024-06-14 13:55:59');
...
INSERT INTO `restaurants` VALUES (1,1,'nom','adresse',1,'description'),(2,2,'dbfjrk','trou du cul sur siagne',15,' du resto'),(3,2,'MacDo','La Seine ou jsp quoi',2,'kjhgfds hgfds edc uhbgfd'),(4,1,'La Dolce Vita','10 Rue de la Pasta, Rome',1,'Cuisine italienne traditionnelle.'),(5,2,'Sushi Master','20 Rue de la Mer, Tokyo',2,'Les meilleurs sushis de la ville.'),(6,3,'El Taco Loco','30 Rue de la Fiesta, Mexico',3,'Cuisine mexicaine authentique.'),(7,4,'Burger Heaven','40 Avenue du Bon Got, New York',4,'Les meilleurs burgers de la ville.'),(8,5,'Spicy Curry','50 Avenue du Got, Delhi',5,'Cuisine indienne pice et savoureuse.'),(9,1,'Pasta Paradise','11 Rue de la Pasta, Rome',1,'Varit de ptes et de sauces.'),(10,2,'Noodle House','21 Rue de la Mer, Tokyo',2,'Nouilles japonaises artisanales.'),(11,3,'Burrito Bliss','31 Rue de la Fiesta, Mexico',3,'Burritos delicieux et varies.'), (12,1,'La chevre d''or','06530 Cabris',1,'Restaurant gastronomique'), (13,1,'Le bistro des saveurs','06530 Le Tignet',1,'Restaurant gastronomique');
...
INSERT INTO `roles` VALUES (1,'Testeur','Role de test'),(2,'customer','Customer Account'),(3,'restaurant','Restaurant Manager Account'),(4,'delivery','Delivery Driver Account'),(5,'commercial','bla bla');
...
INSERT INTO `section` VALUES (1,1,'Antipasti','Entres traditionnelles italiennes.'),(2,1,'Pasta','Plats de ptes divers.'),(3,2,'Sushis','Sushis et sashimis.'),(4,2,'Plats Chauds','Plats cuisins japonais.'),(5,3,'Tacos','Varit de tacos.'),(6,3,'Burritos','Burritos gnreux.'),(7,4,'Burgers','Burgers de qualit.'),(8,4,'Frites','Diffrentes sortes de frites.'),(9,5,'Currys','Divers types de curry.'),(10,5,'Snacks','Snacks pics.'),(11,6,'Pasta Specials','Ptes spciales et sauces.'),(12,7,'Noodles','Nouilles varies.'),(13,8,'Burrito Delights','Burritos spciaux.');
...
-- Dump completed on 2024-06-15 22:11:37
